...
(function() {
    ...
    function ensureModalElement() {
        ...
        modal.className = 'fixed inset-0 z-50 bg-black/75 backdrop-blur-sm hidden flex flex-col justify-center items-center p-2.5 sm:p-4 overflow-y-auto overscroll-contain';
        ...
        modal.innerHTML = `
            ...
            <div id="guest-checkout-modal" class="w-full max-w-2xl flex flex-col justify-center items-center my-auto pointer-events-none">
                <div class="w-full bg-white dark:bg-card-dark border border-slate-200 dark:border-primary/30 rounded-2xl shadow-2xl flex flex-col max-h-[92dvh] sm:max-h-[90vh] text-slate-900 dark:text-slate-100 overflow-hidden relative pointer-events-auto">
                    ...
                    <!-- Sticky Modal Header -->
                    <div class="flex flex-col px-3.5 sm:px-6 pt-2 sm:pt-4 pb-2 sm:pb-3 border-b border-slate-200/80 dark:border-primary/15 bg-white/95 dark:bg-card-dark/95 backdrop-blur-md flex-shrink-0 z-10 gap-2 sm:gap-2.5">
