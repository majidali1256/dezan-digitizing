...
(function() {
    ...
    function ensureModalElement() {
        ...
        modal.className = 'fixed inset-0 z-50 bg-black/75 backdrop-blur-sm hidden flex flex-col justify-center items-center p-2.5 sm:p-4 overflow-hidden';
        ...
        modal.innerHTML = `
            <style>
                ...
                #new-order-modal .modal-card,
                #new-order-modal #guest-checkout-modal > div,
                #new-order-modal > div > div {
                ...
                #new-order-modal #order-service-selection-view,
                #new-order-modal #order-step-2-view > div.overflow-y-auto,
                #new-order-modal #order-step-3-view > div.overflow-y-auto {
                ...
                #new-order-modal #order-service-selection-view::-webkit-scrollbar,
                #new-order-modal #order-step-2-view > div.overflow-y-auto::-webkit-scrollbar,
                #new-order-modal #order-step-3-view > div.overflow-y-auto::-webkit-scrollbar {
                    width: 6px;
                }
                #new-order-modal #order-service-selection-view::-webkit-scrollbar-track,
                #new-order-modal #order-step-2-view > div.overflow-y-auto::-webkit-scrollbar-track,
                #new-order-modal #order-step-3-view > div.overflow-y-auto::-webkit-scrollbar-track {
                    background: transparent;
                }
                #new-order-modal #order-service-selection-view::-webkit-scrollbar-thumb,
                #new-order-modal #order-step-2-view > div.overflow-y-auto::-webkit-scrollbar-thumb,
                #new-order-modal #order-step-3-view > div.overflow-y-auto::-webkit-scrollbar-thumb {
                    background: rgba(148, 163, 184, 0.35);
                    border-radius: 9999px;
                }
                .dark #new-order-modal #order-service-selection-view::-webkit-scrollbar-thumb,
                .dark #new-order-modal #order-step-2-view > div.overflow-y-auto::-webkit-scrollbar-thumb,
                .dark #new-order-modal #order-step-3-view > div.overflow-y-auto::-webkit-scrollbar-thumb {
                ...
                #new-order-modal .transition-all {
            ...
            <div id="guest-checkout-modal" class="w-full max-w-2xl flex flex-col justify-center items-center my-auto pointer-events-none">
                <div class="w-full bg-white dark:bg-card-dark border border-slate-200 dark:border-primary/30 rounded-2xl shadow-2xl flex flex-col max-h-[92dvh] sm:max-h-[90vh] text-slate-900 dark:text-slate-100 overflow-hidden relative pointer-events-auto">
                    
                    <!-- Mobile Drag Indicator Bar -->
                    <div class="w-10 h-1 rounded-full bg-slate-300 dark:bg-slate-700 mx-auto mt-2 mb-0.5 sm:hidden flex-shrink-0"></div>

                    <!-- Sticky Modal Header -->
                    <div class="flex flex-col px-3.5 sm:px-6 pt-2 sm:pt-4 pb-2 sm:pb-3 border-b border-slate-200/80 dark:border-primary/15 bg-white dark:bg-card-dark flex-shrink-0 z-10 gap-2 sm:gap-2.5">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2.5 sm:gap-3 min-w-0 pr-2">
                                ...
                                <div class="min-w-0">
                                    <h3 class="text-base sm:text-2xl font-black text-slate-900 dark:text-white truncate" id="order-modal-header-text">Place an Order</h3>
                            ...
                            <button type="button" onclick="window.closeGuestCheckoutModal()" class="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-white flex items-center justify-center transition-colors cursor-pointer flex-shrink-0" title="Close (Esc)">
                                <span class="material-symbols-outlined text-base sm:text-xl">close</span>
                            </button>
                        </div>

                        <!-- Top Segmented Mode Switcher Pill (Place Order vs. Free Quote) -->
                        <div class="grid grid-cols-2 gap-1 sm:gap-1.5 p-1 bg-slate-100 dark:bg-slate-900/90 rounded-xl border border-slate-200 dark:border-primary/20">
                            <button type="button" id="modal-mode-order-btn" onclick="window.setModalMode(false)" class="py-1 sm:py-1.5 px-2.5 sm:px-3 rounded-lg font-bold text-[11px] sm:text-xs flex items-center justify-center gap-1.5 transition-all bg-primary text-background-dark shadow-xs cursor-pointer">
                                <span class="material-symbols-outlined text-xs sm:text-sm">bolt</span>
                                <span>Place Order</span>
                            </button>
                            <button type="button" id="modal-mode-quote-btn" onclick="window.setModalMode(true)" class="py-1 sm:py-1.5 px-2.5 sm:px-3 rounded-lg font-bold text-[11px] sm:text-xs flex items-center justify-center gap-1.5 transition-all text-slate-600 dark:text-slate-400 hover:text-primary cursor-pointer">
                                <span class="material-symbols-outlined text-xs sm:text-sm">request_quote</span>
                            ...
                            <div class="flex-shrink-0 px-4 py-3 sm:px-6 sm:py-3.5 border-t border-slate-200 dark:border-primary/15 bg-white dark:bg-card-dark flex items-center justify-between gap-2 shadow-lg sm:shadow-none pb-[max(0.75rem,env(safe-area-inset-bottom))]">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <button type="button" id="order-goto-review-btn" onclick="window.goToOrderReviewStep()" class="px-4 sm:px-6 py-2 sm:py-2.5 rounded-xl bg-primary hover:bg-primary-hover text-background-dark text-xs font-black shadow-md shadow-primary/20 cursor-pointer transition-all flex items-center gap-1.5 flex-shrink-0">
                                        <span id="order-goto-review-btn-text">Review &amp; Pay</span>
