...
- **Active Navigation & Internal Linking**:
  ...
  - Global Footers: Harmonized across all pages (`index.html`, `about.html`, `services.html`, `pricing.html`, `portfolio.html`, `contact.html`, `vector-art-conversion.html`, `embroidery-digitizing.html`, `order-success.html`, `profile.html`, `terms.html`, `privacy.html`, `refund-policy.html`).
    ...
    - **Legal & Policies Column**: Strictly restricted to compliance documents (`Terms of Service`, `Privacy Policy`, `Refund & Revision Policy`). Relocated `pricing.html` ("Flat-Rate Pricing") from Legal & Policies to Dedicated Services.
    - **Bottom Bar**: `© 2016-2026 Dezan Digitizing — All Rights Reserved. Terms of Service • Privacy Policy • Refund & Revision Policy`.
